...
function initMap() {
    ...
    const map = new google.maps.Map(document.getElementById('locations-map'), {
      zoom: 7,
      center: {lat: 45.907670, lng: -122.760280},
    });
  
    // Load the stores GeoJSON onto the map.
    map.data.loadGeoJson('Scripts/locations.json', {idPropertyName: 'storeid'});
  
    const apiKey = 'AIzaSyCrkUc8VFc90KwEbBEyS0xC5lhZqxfJ2W0';
  ...
  // List of closest stores on location map
